package com.yan.fastview_library.button;
...
public class PowerButton extends Button {
    ...
    private void getProperties(TypedArray typedArray) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            } else if (attr == R.styleable.PowerButton_p_radius) {
                defaultRadius = (int) typedArray.getDimension(attr, defaultRadius);
            }
        }
        setDrawableSize();
    }
