...
public class PowerTextView extends TextView {
    ...
    private void getRelativDrawable(int shapeType) {
        if (shapeType == ShapeType.RECT) {
            mBackdrawable = DrawableUtils.getRectDrawable(backGroundColor);
        } else if (shapeType == ShapeType.OVAL) {
            mBackdrawable = DrawableUtils.getOvalDrawable(backGroundColor);
        } else if (shapeType == ShapeType.CORNERRECT) {
            mBackdrawable = DrawableUtils.getCorRectDrawable(backGroundColor, defaultRadius);
        }
