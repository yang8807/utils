...
public class LogUtil {
    ...
    public static void v(Object obj, String tag) {
        if ((LEVEL & VERBOSE) > 0)
    ...
    public static void i(Object obj, String tag) {
        if ((LEVEL & INFO) > 0)
            log(Log.INFO, tag, obj);
    }

    public static void w(Object obj, String tag) {
        if ((LEVEL & WARN) > 0)
    ...
    public static void a(Object obj, String tag) {
        if ((LEVEL & ASSERT) > 0)
            log(Log.ASSERT, tag, obj);
    }
    ...
    private static void log(int priority, String tag, Object obj) {
        if (obj != null && mGson != null)
            Log.println(priority, tag, mGson.toJson(obj));
    }
}
